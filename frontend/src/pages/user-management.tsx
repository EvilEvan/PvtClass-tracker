...
export default function UserManagement() {
  ...
  const handleCreateUser = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(getApiUrl(API_ENDPOINTS.CREATE_USER), {
        method: 'POST',
        headers: {
  ...
  const handleMasterUnlock = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await fetch(getApiUrl(API_ENDPOINTS.MASTER_UNLOCK), {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleDeleteUser = async (userId: string, userEmail: string) => {
    if (confirm(`Are you sure you want to delete user: ${userEmail}?`)) {
      try {
        const response = await fetch(getApiUrl(API_ENDPOINTS.DELETE_USER(userId)), {
          method: 'DELETE',
        });
  ...
  const handleUpdateUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(getApiUrl(API_ENDPOINTS.UPDATE_USER(editingUser.id)), {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handlePasswordReset = async (userId: string, userEmail: string) => {
    ...
    try {
      const response = await fetch(getApiUrl(API_ENDPOINTS.UPDATE_USER(userId)), {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
